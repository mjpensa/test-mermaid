...
```mermaid
%%{init: {'theme':'base', 'themeVariables': { 'primaryColor':'#0d47a1','primaryTextColor':'#fff','secondaryColor':'#f57c00','secondaryTextColor':'#fff','tertiaryColor':'#c62828','tertiaryTextColor':'#fff','fontFamily':'arial'}}}%%
